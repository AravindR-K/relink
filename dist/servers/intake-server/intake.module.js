...
const intake_tools_js_1 = require("./intake.tools.js");
...
exports.IntakeModule = IntakeModule = __decorate([
    (0, core_1.Module)({
        name: 'IntakeModule',
        controllers: [intake_tools_js_1.IntakeTools],
        providers: [intake_tools_js_1.IntakeTools],
        exports: [intake_tools_js_1.IntakeTools],
    })
], IntakeModule);
