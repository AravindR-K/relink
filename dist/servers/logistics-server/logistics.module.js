...
const logistics_tools_js_1 = require("./logistics.tools.js");
...
exports.LogisticsModule = LogisticsModule = __decorate([
    (0, core_1.Module)({
        ...
        controllers: [logistics_tools_js_1.LogisticsTools],
        providers: [logistics_tools_js_1.LogisticsTools],
        exports: [logistics_tools_js_1.LogisticsTools],
    })
], LogisticsModule);
