...
const compliance_tools_js_1 = require("./compliance.tools.js");
...
exports.ComplianceModule = ComplianceModule = __decorate([
    (0, core_1.Module)({
        ...
        controllers: [compliance_tools_js_1.ComplianceTools],
        providers: [compliance_tools_js_1.ComplianceTools],
        exports: [compliance_tools_js_1.ComplianceTools],
    })
], ComplianceModule);
