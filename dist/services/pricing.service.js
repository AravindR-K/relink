...
exports.getMarketBenchmark = getMarketBenchmark;
exports.validateSellerPrice = validateSellerPrice;
const MARKET_RATES = {
    aluminum_scrap: {
...
function getMarketBenchmark(materialType, grade) {
...
function validateSellerPrice(sellerPrice, benchmark) {
